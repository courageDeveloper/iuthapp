...
import { AddMainPharmacyServiceBcComponent } from '../add-main-pharmacy-service_bc/add-main-pharmacy-service_bc.component';
...
@Component({
  selector: 'app-view-main-pharmacy-service_bc',
  templateUrl: './view-main-pharmacy-service_bc.component.html',
  styleUrls: ['./view-main-pharmacy-service_bc.component.css']
})
export class ViewMainPharmacyServiceBcComponent implements OnInit {
  //MAIN PHARMACY
  ...
  public export(): void {
    ...
    this.pouchService.getRenderServices().then(items => {
      ...
      this.saveAsExcelFile(this.excelBuffer, 'IUTH Main Pharmacy Services(BC)');
    });
  }
