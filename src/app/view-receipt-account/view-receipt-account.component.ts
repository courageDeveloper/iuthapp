...
@Component({
  selector: 'app-view-receipt-account',
  templateUrl: './view-receipt-account.component.html',
  styleUrls: ['./view-receipt-account.component.css']
})
export class ViewReceiptAccountComponent implements OnInit {
  title;
  ...
  constructor(private router: Router, private dataService: DataService, public dialogRef: MatDialogRef<ViewReceiptAccountComponent>, @Inject(MAT_DIALOG_DATA) public data: any, public toastr: ToastrService, public _DomSanitizer: DomSanitizer, public pouchService: PouchService, private formBuilder: FormBuilder) {
