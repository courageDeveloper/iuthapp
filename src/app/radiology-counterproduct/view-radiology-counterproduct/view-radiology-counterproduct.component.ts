...
import { AddRadiologyCounterProductComponent } from '../add-radiology-counterproduct/add-radiology-counterproduct.component';
...
@Component({
  selector: 'app-view-radiology-counterproduct',
  templateUrl: './view-radiology-counterproduct.component.html',
  styleUrls: ['./view-radiology-counterproduct.component.css']
})
export class ViewRadiologyCounterProductComponent implements OnInit {
  ...
  filterByMonth() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      this.pouchService.getCounterProducts().then(data => {
        ...
        this.pouchService.paginateByDepartment2('counterproduct', this.pouchService.paginationId, "Radiology", undefined, undefined, undefined, undefined, 0).then(paginatedata => {
  ...
  loadDispatchedProducts() {
    this.pouchService.getDispatchedProducts().then(items => {
      items = items.filter(data => data.branch == 'IUTH(Okada)' && data.dispatchdepartment == "Radiology");
      this.dispatchedProducts = items;
  ...
  reloadCounterProducts() {
    this.pouchService.getCounterProducts().then(items => {
      items = items.filter(data => data.branch == 'IUTH(Okada)' && data.department == "Radiology" && data.totalsubitem > 0);
      ...
      this.pouchService.paginateByDepartmentRemoveItem('counterproduct', this.pouchService.paginationId, 'Radiology', undefined, undefined, undefined, undefined, 0).then(paginatedata => {
        this.paginatedCounterProducts = paginatedata;
      });
    });
  }
  ...
  previous() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      ...
      this.pouchService.paginateByDepartmentPrev2('counterproduct', this.pouchService.paginationId, "Radiology", undefined, undefined, undefined, undefined, 0).then(paginatedata => {
        this.paginatedCounterProducts = paginatedata;
  ...
  goToStart() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      ...
      this.pouchService.paginateByDepartmentStart('counterproduct', this.pouchService.paginationId, "Radiology", undefined, undefined, undefined, undefined, 0).then(paginatedata => {
        this.paginatedCounterProducts = paginatedata;
  ...
  checkedExpired() {
    this.pouchService.getCounterProducts().then(items => {
      items = items.filter(data => data.branch == 'IUTH(Okada)' && data.department == "Radiology");
      this.counterProducts = items;
  ...
  sendRefundNotification(counterproduct) {
    ...
    this.pouchService.getStaffs().then(staffs => {
      ...
      staffs = staffs.filter(data => data.department == 'Radiology' || data.department == counterproduct.sourcedepartment || data.department == 'Account' || data.department == 'Audit');
  ...
  checkViewStatus() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      ...
      this.pouchService.getDepartments().then(departments => {
        departments = departments.filter(data => data.name == "Radiology" && data.branch == staff.branch);
  ...
  public export(): void {
    ...
    this.pouchService.getCounterProducts().then(items => {
      ...
      this.saveAsExcelFile(this.excelBuffer, 'IUTH Product(Radiology Counter Product)');
    });
  }
