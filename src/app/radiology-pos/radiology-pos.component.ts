...
export class RadiologyPosComponent implements OnInit {
  ...
  loadCounterProducts() {
    this.pouchService.getCounterProducts().then(counterProducts => {
      ...
      this.pouchService.paginateByDepartment2('counterproduct', this.pouchService.paginationId, "Radiology", undefined, undefined, undefined, false, 0).then(paginatedata => {
  ...
  previous() {
    ...
    this.pouchService.paginateByDepartmentPrev2('counterproduct', this.pouchService.paginationId, "Radiology", undefined, undefined, undefined, false, 0).then(paginatedata => {
      this.paginatedCounterProducts = paginatedata;
  ...
  goToStart() {
    ...
    this.pouchService.paginateByDepartmentStart('counterproduct', this.pouchService.paginationId, "Radiology", undefined, undefined, undefined, false, 0).then(paginatedata => {
      this.paginatedCounterProducts = paginatedata;
