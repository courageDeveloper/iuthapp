...
@Component({
  selector: 'app-add-centralstorecategory_bc',
  templateUrl: './add-centralstorecategory_bc.component.html',
  styleUrls: ['./add-centralstorecategory_bc.component.css']
})
export class AddCentralStoreCategoryBcComponent implements OnInit {
  title;
  isChecked = false;
  ...
  constructor(public dialogRef: MatDialogRef<AddCentralStoreCategoryBcComponent>, @Inject(MAT_DIALOG_DATA) public data: any, public toastr: ToastrService, public pouchService: PouchService, private formBuilder: FormBuilder, ) {
  ...
  ngOnInit() { 
    if (this.data.action == 'add') {
      ...
      this.title = 'Edit';
      this.productcategory = this.data.centralstorecategorybc;
    }
