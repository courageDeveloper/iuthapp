...
@Component({
  selector: 'app-add-main-pharmacy-service',
  templateUrl: './add-main-pharmacy-service.component.html',
  styleUrls: ['./add-main-pharmacy-service.component.css']
})
export class AddMainPharmacyServiceComponent implements OnInit {
  title;
  isChecked = false;
  ...
  constructor(public dialogRef: MatDialogRef<AddMainPharmacyServiceComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private formBuilder: FormBuilder, public toastr: ToastrService, public pouchService: PouchService) { 
