...
import { AddLaboratoryServiceComponent } from '../add-laboratory-service/add-laboratory-service.component';
...
@Component({
  selector: 'app-view-laboratory-service',
  templateUrl: './view-laboratory-service.component.html',
  styleUrls: ['./view-laboratory-service.component.css']
})
export class ViewLaboratoryServiceComponent implements OnInit {
  ...
  reloadRenderServices() {
    this.pouchService.getRenderServices().then(items => {
      ...
      this.pouchService.paginateByDepartmentRemoveItem('renderservice', this.pouchService.paginationId, 'Laboratory').then(paginatedata => {
  ...
  loadRenderServices() {
    this.pouchService.getRenderServices().then(items => {
      ...
      this.pouchService.paginateByDepartment2('renderservice', this.pouchService.paginationId, 'Laboratory').then(paginatedata => {
        this.paginatedRenderServices = paginatedata;
  ...
  previous() {
    ...
    this.pouchService.paginateByDepartmentPrev2('renderservice', this.pouchService.paginationId, 'Laboratory').then(paginatedata => {
      this.paginatedRenderServices = paginatedata;
  ...
  goToStart() {
    ...
    this.pouchService.paginateByDepartmentStart('renderservice', this.pouchService.paginationId, 'Laboratory').then(paginatedata => {
      this.paginatedRenderServices = paginatedata;
  ...
  editRenderService(renderService) {
    let dialogRef = this.dialog.open(AddLaboratoryServiceComponent, {
      width: '500px',
      data: {
  ...
  public export(): void {
    ...
    this.pouchService.getRenderServices().then(items => {
      ...
      this.saveAsExcelFile(this.excelBuffer, 'IUTH Laboratory Services');
    });
  }
