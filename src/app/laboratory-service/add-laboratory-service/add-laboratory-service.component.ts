...
@Component({
  selector: 'app-add-laboratory-service',
  templateUrl: './add-laboratory-service.component.html',
  styleUrls: ['./add-laboratory-service.component.css']
})
export class AddLaboratoryServiceComponent implements OnInit {
  title;
  isChecked = false;
  ...
  constructor(public dialogRef: MatDialogRef<AddLaboratoryServiceComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private formBuilder: FormBuilder, public toastr: ToastrService, public pouchService: PouchService) { 
