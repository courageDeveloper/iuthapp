...
@Component({
  selector: 'app-add-radiology-service',
  templateUrl: './add-radiology-service.component.html',
  styleUrls: ['./add-radiology-service.component.css']
})
export class AddRadiologyServiceComponent implements OnInit {
  title;
  isChecked = false;
  ...
  constructor(public dialogRef: MatDialogRef<AddRadiologyServiceComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private formBuilder: FormBuilder, public toastr: ToastrService, public pouchService: PouchService) { 
