...
import { AddRadiologyServiceComponent } from '../add-radiology-service/add-radiology-service.component';
...
@Component({
  selector: 'app-view-radiology-service',
  templateUrl: './view-radiology-service.component.html',
  styleUrls: ['./view-radiology-service.component.css']
})
export class ViewRadiologyServiceComponent implements OnInit {
  ...
  public export(): void {
    ...
    this.pouchService.getRenderServices().then(items => {
      ...
      this.saveAsExcelFile(this.excelBuffer, 'IUTH Radiology Services');
    });
  }
