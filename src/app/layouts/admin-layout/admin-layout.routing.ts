...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'main-pharmacy-pos', component: MainPharmacyPosComponent, canActivate: [AuthGuardService, RoleGuardService], data: [{ department: 'Main Pharmacy' } , { department: 'Admin' }] },
    ...
    { path: 'view-main-pharmacy-counterproduct', component: ViewMainPharmacyCounterProductComponent, canActivate: [AuthGuardService, RoleGuardService], data: [{ department: 'Main Pharmacy' }, { department: 'Admin' }] },
    { path: 'image-viewer-counterproduct/:index', component: ImageviewerCounterProductComponent, canActivate: [AuthGuardService] },
    { path: 'gopd-pharmacy-pos', component: GopdPharmacyPosComponent, canActivate: [AuthGuardService, RoleGuardService], data: [{ department: 'GOPD Pharmacy' }, { department: 'Admin' }] },
    { path: 'view-gopd-pharmacy-counterproduct', component: ViewGopdPharmacyCounterProductComponent, canActivate: [AuthGuardService, RoleGuardService], data: [{ department: 'GOPD Pharmacy' }, { department: 'Admin' }] },
    { path: 'laboratory-pos', component: LaboratoryPosComponent, canActivate: [AuthGuardService, RoleGuardService], data: [{ department: 'Laboratory' }, { department: 'Admin' }] },
    { path: 'view-laboratory-counterproduct', component: ViewLaboratoryCounterProductComponent, canActivate: [AuthGuardService, RoleGuardService], data: [{ department: 'Laboratory' }, { department: 'Admin' }] },
    { path: 'radiology-pos', component: RadiologyPosComponent, canActivate: [AuthGuardService, RoleGuardService], data: [{ department: 'Radiology' }, { department: 'Admin' }] },
    { path: 'view-radiology-counterproduct', component: ViewRadiologyCounterProductComponent, canActivate: [AuthGuardService, RoleGuardService], data: [{ department: 'Radiology' }, { department: 'Admin' }] },
    { path: 'main-pharmacy-pos-bc', component: MainPharmacyPosBcComponent, canActivate: [AuthGuardService, RoleGuardService], data: [{ department: 'Main Pharmacy' }, { department: 'Admin' }] },
    { path: 'view-main-pharmacy-counterproduct_bc', component: ViewMainPharmacyCounterProductBcComponent, canActivate: [AuthGuardService, RoleGuardService], data: [{ department: 'Main Pharmacy' }, { department: 'Admin' }] },
