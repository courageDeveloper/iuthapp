...
import { AddMainPharmacyCounterProductBcComponent } from '../add-main-pharmacy-counterproduct_bc/add-main-pharmacy-counterproduct_bc.component';
...
@Component({
  selector: 'app-view-main-pharmacy-counterproduct_bc',
  templateUrl: './view-main-pharmacy-counterproduct_bc.component.html',
  styleUrls: ['./view-main-pharmacy-counterproduct_bc.component.css']
})
export class ViewMainPharmacyCounterProductBcComponent implements OnInit {
  ...
  loadDispatchedProducts() {
    this.pouchService.getDispatchedProducts().then(items => {
      items = items.filter(data => data.branch == 'Benin Centre' && data.dispatchdepartment == "Main Pharmacy");
      this.dispatchedProducts = items;
  ...
  public export(): void {
    ...
    this.pouchService.getCounterProducts().then(items => {
      ...
      this.saveAsExcelFile(this.excelBuffer, 'IUTH Product(Main Pharmacy(BC) Counter Product)');
    });
  }
