...
@Component({
  selector: 'app-add-pharmacystorecategory',
  templateUrl: './add-pharmacystorecategory.component.html',
  styleUrls: ['./add-pharmacystorecategory.component.css']
})
export class AddPharmacyStoreCategoryComponent implements OnInit {
  title;
  isChecked = false;
  ...
  ngOnInit() {
    ...
    if (this.data.action == 'add') {
      ...
      this.title = 'Edit';
      this.productcategory = this.data.pharmacystorecategory;
    }
