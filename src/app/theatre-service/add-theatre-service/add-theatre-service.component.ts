...
@Component({
  selector: 'app-add-theatre-service',
  templateUrl: './add-theatre-service.component.html',
  styleUrls: ['./add-theatre-service.component.css']
})
export class AddTheatreServiceComponent implements OnInit {
  title;
  isChecked = false;
  ...
  constructor(public dialogRef: MatDialogRef<AddTheatreServiceComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private formBuilder: FormBuilder, public toastr: ToastrService, public pouchService: PouchService) { 
