...
@Component({
  selector: 'app-view-history-staff',
  templateUrl: './view-history-staff.component.html',
  styleUrls: ['./view-history-staff.component.css']
})
export class ViewHistoryStaffComponent implements OnInit {
