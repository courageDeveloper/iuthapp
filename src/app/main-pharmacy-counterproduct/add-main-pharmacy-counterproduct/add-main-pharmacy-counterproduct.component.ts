...
export class AddMainPharmacyCounterProductComponent implements OnInit {
  ...
  constructor(private router: Router, public dialogRef: MatDialogRef<AddMainPharmacyCounterProductComponent>, @Inject(MAT_DIALOG_DATA) public data: any, public toastr: ToastrService, public _DomSanitizer: DomSanitizer, public pouchService: PouchService, private formBuilder: FormBuilder) {
