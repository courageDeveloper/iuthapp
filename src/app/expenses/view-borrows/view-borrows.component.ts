...
@Component({
  selector: 'app-view-borrows',
  templateUrl: './view-borrows.component.html',
  styleUrls: ['./view-borrows.component.css']
})
export class ViewBorrowsComponent implements OnInit {
  ...
  filterByMonth() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      this.pouchService.getExpenses().then(data => {
        this.borrows = data.filter(data => data.branch == staff.branch);
        ...
        this.pouchService.paginateByExpense('expense', this.pouchService.paginationId, undefined, undefined, undefined, false).then(paginatedata => {
  ...
  reloadBorrows() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      ...
      this.pouchService.getExpenses().then(data => {
        ...
        this.pouchService.paginateByExpenseRemoveItem('expense', this.pouchService.paginationId, undefined, undefined, undefined, false).then(paginatedata => {
          this.paginatedBorrows = paginatedata;
  ...
  previous() {
    ...
    this.pouchService.paginateByExpensePrev('expense', this.pouchService.paginationId, undefined, undefined, undefined, false).then(paginatedata => {
      this.paginatedBorrows = paginatedata;
  ...
  goToStart() {
    ...
    this.pouchService.paginateByExpenseStart('expense', this.pouchService.paginationId, undefined, undefined, undefined, false).then(paginatedata => {
      this.paginatedBorrows = paginatedata;
  ...
  loadTotalBorrows() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      this.pouchService.getExpenses().then(data => {
        this.totalBorrows = data.filter(data => data.branch == staff.branch);
  ...
  filterDate() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      this.pouchService.getExpenses().then(borrows => {
        borrows = borrows.filter(data => data.branch == staff.branch);
