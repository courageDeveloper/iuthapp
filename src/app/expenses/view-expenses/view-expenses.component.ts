...
export class ViewExpensesComponent implements OnInit {
      ...
      this.pouchService.getExpenses().then(data => {
        if (staff.department != "Account" && staff.department != "Revenue" && staff.department != "Audit") { //If not those departments then filter by specific department logged.
          ...
          if (!this.isFilterDepartment) {
            ...
            this.expenses = data.filter(data => data.branch == staff.branch && data.departmentname == this.selectedDepartment);
          }
        }
        ...
        this.pouchService.paginateByExpense('expense', this.pouchService.paginationId, undefined, false).then(paginatedata => {
        ...
        this.getTotalExpenses(this.expenses);
      });
    });
  }
      ...
      this.pouchService.getExpenses().then(data => {
        if (this.selectedDepartment != "Account" && this.selectedDepartment != "Revenue" && this.selectedDepartment != "Audit") { //If not those departments then filter by specific department logged.
          if (!this.isFilterMonth) {
            ...
            this.pouchService.paginationId = this.expenses[0].id; //Reverse of what is meant to be;
            this.pouchService.paginateByExpense('expense', this.pouchService.paginationId, this.selectedDepartment, false).then(paginatedata => {
              this.paginatedExpenses = paginatedata;
            });
          }
          else {
            this.expenses = data.filter(data => {
              var dbMonth = this.months[new Date(data.date).getMonth()];
              var dbYear = new Date(data.date).getFullYear();
            ...
            this.pouchService.paginateByExpense('expense', this.pouchService.paginationId, this.selectedDepartment, false).then(paginatedata => {
              this.paginatedExpenses = paginatedata;
              this.paginatedExpenses = data.filter(data => {
                var dbMonth = this.months[new Date(data.date).getMonth()];
                var dbYear = new Date(data.date).getFullYear();
                return this.selectedMonth == dbMonth && this.selectedYear == dbYear && data.branch == staff.branch && data.departmentname == this.selectedDepartment;
              });
  ...
  reloadExpenses() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      ...
      this.pouchService.getExpenses().then(data => {
        ...
        this.pouchService.paginateByExpenseRemoveItem('expense', this.pouchService.paginationId, undefined, false).then(paginatedata => {
          this.paginatedExpenses = paginatedata;
  ...
  previous() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      ...
      if (this.isFilterDepartment) {
        if (staff.department != "Account" && staff.department != "Revenue" && staff.department != "Audit") { //If not those departments then filter by specific department logged.
          this.pouchService.paginateByExpensePrev('expense', this.pouchService.paginationId, this.selectedDepartment, false).then(paginatedata => {
            this.paginatedExpenses = paginatedata;

          });
        }
        else {
          this.pouchService.paginateByExpensePrev('expense', this.pouchService.paginationId, undefined, false).then(paginatedata => {
            this.paginatedExpenses = paginatedata;
  ...
  goToStart() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      ...
      if (this.isFilterDepartment) {
        if (staff.department != "Account" && staff.department != "Revenue" && staff.department != "Audit") { //If not those departments then filter by specific department logged.
          this.pouchService.paginateByExpenseStart('expense', this.pouchService.paginationId, this.selectedDepartment, false).then(paginatedata => {
            this.paginatedExpenses = paginatedata;
            
          });
        }
        else {
          this.pouchService.paginateByExpenseStart('expense', this.pouchService.paginationId, undefined, false).then(paginatedata => {
            this.paginatedExpenses = paginatedata;
