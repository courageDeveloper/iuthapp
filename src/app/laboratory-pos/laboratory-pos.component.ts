...
@Component({
  selector: 'app-laboratory-pos',
  templateUrl: './laboratory-pos.component.html',
  styleUrls: ['./laboratory-pos.component.css']
})
export class LaboratoryPosComponent implements OnInit {
  ...
  loadCounterProducts() {
    this.pouchService.getCounterProducts().then(counterProducts => {
      counterProducts = counterProducts.filter(data => data.branch == 'IUTH(Okada)' && data.department == "Laboratory" && data.isexpired == false);
  ...
  loadServices() {
    this.pouchService.getRenderServices().then(renderservices => {
      renderservices = renderservices.filter(data => data.branch == 'IUTH(Okada)' && data.department == "Laboratory");
  ...
  viewLaboratoryCounterProducts() {
    this.router.navigate(['view-laboratory-counterproduct']);
  }
