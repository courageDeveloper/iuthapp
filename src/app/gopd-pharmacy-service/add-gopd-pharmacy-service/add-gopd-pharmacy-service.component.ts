...
@Component({
  selector: 'app-add-gopd-pharmacy-service',
  templateUrl: './add-gopd-pharmacy-service.component.html',
  styleUrls: ['./add-gopd-pharmacy-service.component.css']
})
export class AddGopdPharmacyServiceComponent implements OnInit {
  title;
  isChecked = false;
  ...
  constructor(public dialogRef: MatDialogRef<AddGopdPharmacyServiceComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private formBuilder: FormBuilder, public toastr: ToastrService, public pouchService: PouchService) { 
