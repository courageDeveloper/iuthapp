...
export class GopdPharmacyPosComponent implements OnInit {
  ...
  loadCounterProducts() {
    this.pouchService.getCounterProducts().then(counterProducts => {
      ...
      this.pouchService.paginateByDepartment2('counterproduct', this.pouchService.paginationId, "GOPD Pharmacy", undefined, undefined, undefined, false).then(paginatedata => {
  ...
  previous() {
    ...
    this.pouchService.paginateByDepartmentPrev2('counterproduct', this.pouchService.paginationId, "GOPD Pharmacy", undefined, undefined, undefined, false).then(paginatedata => {
      this.paginatedCounterProducts = paginatedata;
  ...
  goToStart() {
    ...
    this.pouchService.paginateByDepartmentStart('counterproduct', this.pouchService.paginationId, "GOPD Pharmacy", undefined, undefined, undefined, false).then(paginatedata => {
      this.paginatedCounterProducts = paginatedata;
