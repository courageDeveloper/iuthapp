...
@Component({
  selector: 'app-gopd-pharmacy-pos',
  templateUrl: './gopd-pharmacy-pos.component.html',
  styleUrls: ['./gopd-pharmacy-pos.component.css']
})
export class GopdPharmacyPosComponent implements OnInit {
  ...
  loadPage() {
    this.sales = {
      ...
      departmentloaned: '',
      individualloanid: '',
      departmentloaning: 'GOPD Pharmacy',
  ...
  loadCounterProducts() {
    this.pouchService.getCounterProducts().then(counterProducts => {
      counterProducts = counterProducts.filter(data => data.branch == 'IUTH(Okada)' && data.department == "GOPD Pharmacy" && data.isexpired == false);
      ...
      this.pouchService.paginateByDepartment2('counterproduct', this.pouchService.paginationId, "GOPD Pharmacy", undefined, undefined, undefined, false, 0).then(paginatedata => {
  ...
  previous() {
    ...
    this.pouchService.paginateByDepartmentPrev2('counterproduct', this.pouchService.paginationId, "GOPD Pharmacy", undefined, undefined, undefined, false, 0).then(paginatedata => {
      this.paginatedCounterProducts = paginatedata;
  ...
  goToStart() {
    ...
    this.pouchService.paginateByDepartmentStart('counterproduct', this.pouchService.paginationId, "GOPD Pharmacy", undefined, undefined, undefined, false, 0).then(paginatedata => {
      this.paginatedCounterProducts = paginatedata;
  ...
  loadServices() {
    this.pouchService.getRenderServices().then(renderservices => {
      renderservices = renderservices.filter(data => data.branch == 'IUTH(Okada)' && data.department == "GOPD Pharmacy");
      ...
      this.pouchService.paginateByDepartment2('renderservice', this.pouchService.paginationId, "GOPD Pharmacy").then(paginatedata => {
  ...
  previousService() {
    ...
    this.pouchService.paginateByDepartmentPrev2('renderservice', this.pouchService.paginationId, "GOPD Pharmacy").then(paginatedata => {
      this.paginatedRenderServices = paginatedata;
  ...
  goToStartService() {
    ...
    this.pouchService.paginateByDepartmentStart('renderservice', this.pouchService.paginationId, "GOPD Pharmacy").then(paginatedata => {
      this.paginatedRenderServices = paginatedata;
  ...
  viewPharmacyCounterProducts() {
    this.router.navigate(['view-gopd-pharmacy-counterproduct']);
  }
