...
export class AddVendorDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<AddVendorDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: any, public toastr: ToastrService, public pouchService: PouchService, private formBuilder: FormBuilder, private router: Router) {
    this.vendor = {
