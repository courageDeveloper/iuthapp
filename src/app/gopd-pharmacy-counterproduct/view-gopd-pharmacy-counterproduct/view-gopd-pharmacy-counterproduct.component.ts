...
@Component({
  selector: 'app-view-gopd-pharmacy-counterproduct',
  templateUrl: './view-gopd-pharmacy-counterproduct.component.html',
  styleUrls: ['./view-gopd-pharmacy-counterproduct.component.css']
})
export class ViewGopdPharmacyCounterProductComponent implements OnInit {
  ...
  filterByMonth() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      this.pouchService.getCounterProducts().then(data => {
        ...
        this.pouchService.paginateByDepartment2('counterproduct', this.pouchService.paginationId, "GOPD Pharmacy", undefined, undefined, undefined, undefined, 0).then(paginatedata => {
  ...
  loadDispatchedProducts() {
    this.pouchService.getDispatchedProducts().then(items => {
      items = items.filter(data => data.branch == 'IUTH(Okada)' && data.dispatchdepartment == "GOPD Pharmacy");
      this.dispatchedProducts = items;
  ...
  reloadCounterProducts() {
    this.pouchService.getCounterProducts().then(items => {
      items = items.filter(data => data.branch == 'IUTH(Okada)' && data.department == "GOPD Pharmacy" && data.totalsubitem > 0);
      ...
      this.pouchService.paginateByDepartmentRemoveItem('counterproduct', this.pouchService.paginationId, 'GOPD Pharmacy', undefined, undefined, undefined, undefined, 0).then(paginatedata => {
        this.paginatedCounterProducts = paginatedata;
  ...
  previous() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      ...
      this.pouchService.paginateByDepartmentPrev2('counterproduct', this.pouchService.paginationId, "GOPD Pharmacy", undefined, undefined, undefined, undefined, 0).then(paginatedata => {
        this.paginatedCounterProducts = paginatedata;
  ...
  goToStart() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      ...
      this.pouchService.paginateByDepartmentStart('counterproduct', this.pouchService.paginationId, "GOPD Pharmacy", undefined, undefined, undefined, undefined, 0).then(paginatedata => {
        this.paginatedCounterProducts = paginatedata;
  ...
  checkViewStatus() {
    ...
    this.pouchService.getStaff(localStorageItem).then(staff => {
      ...
      this.pouchService.getDepartments().then(departments => {
        departments = departments.filter(data => data.name == "GOPD Pharmacy" && data.branch == staff.branch);
  ...
  editCounterProduct(counterproduct) {
    let dialogRef = this.dialog.open(AddGopdPharmacyCounterProductComponent, {
      height: '500px',
      width: '500px',
      data: {
  ...
  sendRefundNotification(counterproduct) {
    ...
    this.pouchService.getStaffs().then(staffs => {
      ...
      staffs = staffs.filter(data => data.department == 'GOPD Pharmacy' || data.department == counterproduct.sourcedepartment || data.department == 'Account' || data.department == 'Audit');
  ...
  public export(): void {
    ...
    this.pouchService.getCounterProducts().then(items => {
      ...
      this.saveAsExcelFile(this.excelBuffer, 'IUTH Product(GOPD Pharmacy Counter Product)');
    });
  }
